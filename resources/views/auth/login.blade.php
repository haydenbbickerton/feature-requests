...
<div class="container">
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg">Welcome to Feature Requests. This is a demo application.</p>
      <p class="login-box-msg">Please click the button below to authenticate using your Google account.</p>
